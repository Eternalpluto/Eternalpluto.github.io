    ...
    if globalPageType === 'post'
      ...
      #site-info
        ...
        if theme.subtitle.enable
          - var loadSubJs = true
          #site-subtitle
            span#subtitle(data-type='home')
        if theme.social
          #site_social_icons
            !=partial('includes/header/social', {}, {cache: true})
      #scroll-down
        i.fas.fa-angle-down.scroll-down-effects
    else if globalPageType === 'tag' || globalPageType === 'tags'
      #page-site-info
        h1#site-title=page.tag || page.title
        if theme.subtitle.enable
          - var loadSubJs = true
          .site-subtitle-page
            span#subtitle(data-type='tag')
    else if globalPageType === 'category' || globalPageType === 'categories'
      #page-site-info
        h1#site-title=page.category || page.title
        if theme.subtitle.enable
          - var loadSubJs = true
          .site-subtitle-page
            span#subtitle(data-type='category')
    else if globalPageType === 'archive'
      #page-site-info
        h1#site-title=page.title || _p('page.archives')
        if theme.subtitle.enable
          - var loadSubJs = true
          .site-subtitle-page
            span#subtitle(data-type='archive')
    else
      #page-site-info

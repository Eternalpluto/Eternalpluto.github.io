...
if theme.other_pages_font && theme.other_pages_font.font_link
  link(rel='stylesheet' href=url_for(theme.other_pages_font.font_link) media="print" onload="this.media='all'")
